...
describe("getTopCategory", () => {
  test("should return 'The name of the category with the highest total amount'", () => {
    const expenses = [
  ...
  test("should return the first category in case of a tie.", () => {
    const expenses = [
  ...
  test("should return Null If the array you passed in is empty ([]).", () => {
    const emptyArr = [];
